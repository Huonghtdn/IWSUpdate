...
const selectAllTags = "select tag.tag_name, tag.id from tag inner join tag_has_news on tag.id = tag_has_news.tag_id where tag_has_news.news_id = ?;"
...
const selectAllNews = "select news.id , news.title, news.content,news.short_intro,news.image, category.category_name, category.id, news.author_name,news.date_created from news inner join category on category.id = news.category_id ;"
const selectNewsById = "select news.id , news.title, news.content, news.short_intro, news.image, news.date_created, category.category_name,news.author_name, news.category_id from news inner join category on category.id = news.category_id where news.id = ?;"

...
const selectCategoryById = "select * from category where id = ?"
const selectAllNewInCategory ="select category.id , category.category_name , news.title, news.short_intro,news.date_created,news.image, news.id, news.author_name from category inner join news on category.id = news.category_id where category.id = ?;";
